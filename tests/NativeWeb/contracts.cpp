...
int main() {
  ...
  d.attribute(d.find("distribution"), "class", "normal");
  d.render(800, 600);
  check(d.bounds(d.find("distribution-a")).x == distribution_x + 15 &&
        d.bounds(d.find("distribution-b")).x == distribution_x + 65,
        "normal gap restores zero flex gap");
  d.attribute(d.find("distribution"), "class", "variable-normal");
  d.render(800, 600);
  check(d.bounds(d.find("distribution-a")).x == distribution_x + 12 &&
        d.bounds(d.find("distribution-b")).x == distribution_x + 68,
  ...
  check(d.bounds(d.find("calc-child")).x == d.bounds(d.find("calc-parent")).x + 38 &&
        d.bounds(d.find("calc-child")).y == d.bounds(d.find("calc-parent")).y + 40,
        "escaped references retain identity through inherited calc shorthand");
  d.remove_attribute(d.find("calc-parent"), "class");
  d.render(800, 600);

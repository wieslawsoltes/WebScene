...
public sealed class ManifestJavaScriptBindingGenerator : IIncrementalGenerator
{
        ...
        string policyPath)
    {
        ...
        source.Append("namespace ").Append(generation.Namespace).AppendLine(";")
            ...
            .AppendLine(" : global::WebScene.JavaScript.Interop.IJavaScriptCallbackTarget, global::WebScene.JavaScript.Interop.IJavaScriptObjectReferenceProvider, global::System.IAsyncDisposable")
            .AppendLine("{")
            .AppendLine("    private global::WebScene.JavaScript.Interop.IJavaScriptBidirectionalInvoker? __webSceneInvoker;")
            ...
            .AppendLine("        __webSceneReference = await invoker.RegisterCallbackTargetAsync(")
            .AppendLine("            this,")

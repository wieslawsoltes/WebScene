...
See `tooling/webscene` for TypeScript declarations and bundler plugins. Avalonia
applications can host these packages with `WebScene.Sdk.Avalonia` and its native
`WebSceneComponentHost`. Application templates remain intentionally absent.

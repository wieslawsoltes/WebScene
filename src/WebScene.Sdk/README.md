...
See `tooling/webscene` for TypeScript declarations and bundler plugins. Application
templates are intentionally absent until a reusable native component host is ready.

...
const _runtimeLibrary = String.fromEnvironment('HTMLML_RUNTIME_LIBRARY');
const _bridgeLibrary = String.fromEnvironment('HTMLML_FLUTTER_BRIDGE');
const _cacheDirectory = String.fromEnvironment('HTMLML_CACHE_DIRECTORY');
...
class TradingViewExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'HtmlML Flutter TradingView',
        ...
        children: [
          Positioned.fill(
            child: HtmlMlView(
              ...
              onReady: () {
                debugPrint('[HtmlML example] TradingView ready');
              ...
              onConsoleMessage: (message) {
                debugPrint('[HtmlML ${message.level}] ${message.message}');
              },
              onError: _setError,
            ),
          ),

...
output="$output_dir/libhtmlml_flutter_bridge.dylib"
...
xcrun clang++ \
  ...
  -framework CoreText \
  -I "$repo_dir/experiments/HtmlML.NativeEngine.Probe/native" \
  "$package_dir/native/macos/htmlml_flutter_bridge.mm" \
  -o "$output"

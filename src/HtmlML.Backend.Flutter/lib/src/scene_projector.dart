...
final class HtmlMlSceneProjector {
  ...
  SceneApplyResult apply(Pointer<HtmlMlSceneView> scenePointer) {
  ...
  bool _validateLayer(HtmlMlSceneView scene, HtmlMlCanvasLayer layer) =>
  ...
  ui.Picture _compileDom(HtmlMlSceneView scene, {required bool foreground}) {
  ...
  void _drawDomText(
    ui.Canvas canvas,
    HtmlMlSceneView scene,
    HtmlMlSceneCommand command,
  ) {
  ...
  void _drawDomShadow(ui.Canvas canvas, HtmlMlSceneCommand command) {
  ...
  _RetainedLayer _compileLayer(HtmlMlSceneView scene, HtmlMlCanvasLayer layer) {
    final recorder = ui.PictureRecorder();
    final canvas = ui.Canvas(
      recorder,
      ui.Rect.fromLTWH(
  ...
  static Matrix4 _matrix(HtmlMlCanvasCommand command) {
  ...
  static void _appendArc(ui.Path path, HtmlMlCanvasCommand command) {
    final value = command.values;
  ...
  static ui.Rect _domRect(HtmlMlSceneCommand command) =>
      ui.Rect.fromLTWH(command.x, command.y, command.width, command.height);

  static ui.RRect _domRRect(HtmlMlSceneCommand command) {
  ...
  static ui.Rect _canvasRect(HtmlMlCanvasCommand command) => ui.Rect.fromLTWH(
        command.values[0],
        command.values[1],
        command.values[2],
        command.values[3],
  ...
  static void _applyDomRotation(ui.Canvas canvas, HtmlMlSceneCommand command) {
  ...
  static String _domString(HtmlMlSceneView scene, int index) =>
  ...
  static String _stringAt(HtmlMlSceneView scene, int index) {

...
public sealed class NativeSceneSurface : Control, INativeHtmlMlRenderDiagnostics
{
    ...
    public void SetEngine(IntPtr engine)
    {
        ...
        NativeHtmlMlApi.EngineSetVisible(_engine, 1);
        StartProjection();
    ...
    private void StartProjection()
    {
        ...
        NativeHtmlMlApi.EngineRequestSceneCheckpoint(_engine);
    ...
    private void OnSurfaceDetached(object? sender, VisualTreeAttachmentEventArgs args)
    {
        ...
        if (_engine != IntPtr.Zero)
        {
            ...
            NativeHtmlMlApi.EngineSetVisible(_engine, 0);
        }
    }
    ...
    public async Task<INativeHtmlMlFrozenPresentation?> CaptureFrozenPresentationAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (Stopwatch.GetTimestamp() < deadline)
        {
            ...
            var scene = NativeHtmlMlApi.EngineAcquireLatestScene(engine);
                ...
                || (header.Flags & sceneCheckpoint) == 0)
            {
                ...
                NativeHtmlMlApi.EngineRequestSceneCheckpoint(engine);
                NativeFrameInput.Submit(
                    engine,
                    Stopwatch.GetTimestamp() * 1000.0 / Stopwatch.Frequency);
                await Task.Delay(2, cancellationToken).ConfigureAwait(false);
            ...
            try
            {
                return await Dispatcher.UIThread.InvokeAsync(
                        () => (INativeHtmlMlFrozenPresentation)
    ...
    public void OnNativeScenePublished(NativeScenePublished scene)
    {
        ...
        var cursorKind = unchecked((int)NativeHtmlMlApi.EngineGetCursor(_engine));
    ...
    private void EnqueuePointer(uint kind, PointerEventArgs args)
    {
        ...
        if (NativeHtmlMlApi.EngineEnqueue(_engine, in input) != 0)
        {
        ...
        bool includeAnimationFrame = false)
    {
        ...
        if (includeAnimationFrame)
        {
            ...
            accepted = NativeHtmlMlApi.EngineEnqueueResizeFrame(
                _engine,
                in input,
                in frame);
        }
        ...
        {
            accepted = NativeHtmlMlApi.EngineEnqueue(_engine, in input);
        }
    ...
    public ulong SubmitWheel(double x, double y, double deltaY, uint modifiers = 0)
    {
        ...
        return NativeHtmlMlApi.EngineEnqueue(_engine, in input) != 0 ? sequence : 0;
    }
    ...
    public override unsafe void Render(DrawingContext context)
    {
        ...
        var scene = NativeHtmlMlApi.EngineAcquireNextScene(_engine);
        if (scene != IntPtr.Zero)
        {
...
internal sealed class LivePerformanceHud : Border
{
    ...
    private void Start()
    {
        NativeHtmlMlApi.EngineGetMetrics(_engine, out var metrics);
...
internal sealed unsafe class NativeCanvasSceneRenderer
{
    ...
    private void DumpLayerIfRequested(
        ...
        SKPicture picture)
    {
        var directory = Environment.GetEnvironmentVariable("HTMLML_PROBE_DUMP_LAYERS");
...
internal static class NativeFrameInput
{
    ...
    public static void Submit(IntPtr engine, double timestampMilliseconds)
    {
        ...
        NativeHtmlMlApi.EngineEnqueue(engine, in input);
    }
}
...
public static unsafe class NativeHtmlMlApi
{
    ...
    static NativeHtmlMlApi()
    {
        NativeLibrary.SetDllImportResolver(typeof(NativeHtmlMlApi).Assembly, ResolveLibrary);
    }
    ...
    public static void ConfigureLibraryPath(string libraryPath)
    {
        ...
        lock (LibraryPathGate)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"The native HtmlML runtime is already bound to '{_libraryPath}' and cannot be rebound to '{fullPath}' in the same process.");
            }
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_prewarm")]
    ...
    public static IntPtr EngineCreate(
        ...
        IHtmlMlResourceLoader resourceLoader,
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_load_url")]
        ...
        ref NativeTextMetrics metrics)
    {
        ...
        {
            Console.Error.WriteLine($"[HtmlML native text shaping] {error}");
            return 0;
        }
    }
        ...
        float viewportHeight)
    {
        ...
        catch (Exception error)
        {
            ...
            Console.Error.WriteLine($"[HtmlML native scene publication] {error}");
        }
    }
        ...
        nuint destinationCapacity)
    {
        ...
        {
            Console.Error.WriteLine($"[HtmlML native resource loader] {error}");
            return 0;
        }
    }

    private sealed class ResourceBridge(
        IHtmlMlResourceLoader loader,
        Action<NativeScenePublished> scenePublished)
    {
            ...
            nuint capacity)
        {
            ...
            if (!_pendingCopies.TryGetValue(key, out var bytes))
            {
                ...
                {
                    1 => HtmlMlResourceKind.Script,
                    2 => HtmlMlResourceKind.StyleSheet,
                    3 => HtmlMlResourceKind.Image,
                    _ => HtmlMlResourceKind.Markup
                };
                var request = new HtmlMlResourceRequest(address, null, resourceKind)
                {
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_enqueue_resize_frame")]
    internal static extern byte EngineEnqueueResizeFrame(
        IntPtr engine,
        in InputEvent resize,
        in InputEvent frame);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_cursor")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_take_host_request")]
    private static extern nuint EngineTakeHostRequest(
        IntPtr engine,
        byte[]? destination,
        nuint destinationCapacity);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_take_console_message")]
    private static extern nuint EngineTakeConsoleMessage(
        IntPtr engine,
        byte[]? destination,
        nuint destinationCapacity);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_take_input_dispatch_failure")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_copy_first_iframe_html")]
    private static extern nuint EngineCopyFirstIframeHtml(
        IntPtr engine,
        byte[]? destination,
        nuint destinationCapacity);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_copy_scene_diagnostics")]
    private static extern nuint EngineCopySceneDiagnostics(
        IntPtr engine,
        byte[]? destination,
        nuint destinationCapacity);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_copy_feature_use")]
    private static extern nuint EngineCopyFeatureUse(
        IntPtr engine,
        byte[]? destination,
        nuint destinationCapacity);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_copy_event_listener_inventory")]
    private static extern nuint EngineCopyEventListenerInventory(
        IntPtr engine,
        byte[]? destination,
        nuint destinationCapacity);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_copy_canvas_layouts")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_acquire_next_scene")]
    public static extern IntPtr EngineAcquireNextScene(IntPtr engine);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_request_scene_checkpoint")]
    public static extern byte EngineRequestSceneCheckpoint(IntPtr engine);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_request_low_memory")]
    public static extern byte EngineRequestLowMemory(IntPtr engine);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_set_visible")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_scene_get_header")]
    internal static extern byte SceneGetHeader(IntPtr scene, out SceneHeader header);

    [DllImport(LibraryName, EntryPoint = "htmlml_scene_get_commands")]
    internal static extern SceneCommand* SceneGetCommands(IntPtr scene, out uint count);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_metrics")]
    public static extern void EngineGetMetrics(IntPtr engine, out EngineMetrics metrics);

    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_input_dispatch_metrics")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_animation_frame_metrics")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_scene_flow_metrics")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_resize_frame_metrics")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_resource_cache_metrics")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_process_cache_metrics")]
    ...
    [DllImport(LibraryName, EntryPoint = "htmlml_engine_get_memory_metrics")]

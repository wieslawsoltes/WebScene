...
void main(List<String> arguments) async {
  if (arguments.length != 3) {
    stderr.writeln(
      ...
      '<libwebscene_native_engine.dylib> <libwebscene_flutter_bridge.dylib> '
      '<document-url>',
    );
    exitCode = 64;
    return;
  ...
  final resourceCount =
    ...
    'webscene_flutter_resource_request_count',
  );
  ...
  final cacheCString = cString(
    '${Directory.systemTemp.path}/webscene-flutter-native-smoke',
  );

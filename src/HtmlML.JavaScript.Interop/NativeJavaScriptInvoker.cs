...
public sealed partial class NativeJavaScriptInvoker : IJavaScriptBidirectionalInvoker
{
        ...
        (() => {
          ...
          const keep = value => {
            if ((typeof value !== "object" && typeof value !== "function") || value === null) {
              throw new TypeError("HtmlML interop expected a JavaScript object result.");
            }
          ...
          const get = handle => {
            ...
            if (value === undefined) throw new Error(`Unknown HtmlML interop handle ${handle}.`);
            return value;
          };
          const decodeArgument = value => {
            if (!value || typeof value !== "object") return value;
            if (value.__htmlMlUndefined === true) return undefined;
            if (Number.isInteger(value.__htmlMlHandle)) return get(value.__htmlMlHandle);
          ...
          const args = json => JSON.parse(json).flatMap(value =>
            value && typeof value === "object" && Array.isArray(value.__htmlMlRest)
              ? value.__htmlMlRest.map(decodeArgument)
          ...
          const encodeCallbackValue = (value, seen = new WeakSet()) => {
            ...
            if (value === undefined) return { __htmlMlUndefined: true };
            if (typeof value === "function") {
              return { __htmlMlHandle: keep(value), __htmlMlKind: "function" };
            }
            if (typeof value !== "object") return String(value);
            if (value instanceof Date) return value.toISOString();
            if (seen.has(value)) {
              return { __htmlMlHandle: keep(value), __htmlMlKind: "object" };
            }
            seen.add(value);
          ...
          globalThis.__htmlMlDotNetInterop = Object.freeze({
            ...
            takePromise(promise) {
              ...
              if (!state) throw new Error(`Unknown HtmlML promise ${promise}.`);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var json = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.getGlobalObject({JsonSerializer.Serialize(globalName)})",
            "htmlml-interop-get-global-object.js",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        var json = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.getGlobalValue({JsonSerializer.Serialize(globalName)})",
            "htmlml-interop-get-global-value.js",
            cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var operationJson = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.getGlobalPromise({JsonSerializer.Serialize(globalName)})",
            "htmlml-interop-get-global-promise.js",
            cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var json = await EvaluateAsync(
            ...
            "htmlml-interop-global-object.js",
            cancellationToken).ConfigureAwait(false);
        return new JavaScriptObjectReference(DeserializeRequired<long>(json));
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var json = await EvaluateAsync(
            ...
            "htmlml-interop-global-value.js",
            cancellationToken).ConfigureAwait(false);
        return Deserialize<T>(json);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var operationJson = await EvaluateAsync(
            ...
            "htmlml-interop-global-promise.js",
            cancellationToken).ConfigureAwait(false);
        var operation = DeserializeRequired<long>(operationJson);
        var state = await WaitForPromiseAsync(operation, cancellationToken)
            .ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        var json = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.construct({JsonSerializer.Serialize(globalName)}, {SerializeArguments(arguments)})",
            "htmlml-interop-construct.js",
            cancellationToken).ConfigureAwait(false);
        return new JavaScriptObjectReference(DeserializeRequired<long>(json));
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        var json = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.getObjectProperty({target.Id}, {JsonSerializer.Serialize(property)})",
            "htmlml-interop-get-object-property.js",
            cancellationToken).ConfigureAwait(false);
        return new JavaScriptObjectReference(DeserializeRequired<long>(json));
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        var json = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.getProperty({target.Id}, {JsonSerializer.Serialize(property)})",
            "htmlml-interop-get-property.js",
            cancellationToken).ConfigureAwait(false);
        return Deserialize<T>(json);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        var operationJson = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.getPromiseProperty({target.Id}, {JsonSerializer.Serialize(property)})",
            "htmlml-interop-get-promise-property.js",
            cancellationToken).ConfigureAwait(false);
        var operation = DeserializeRequired<long>(operationJson);
        var state = await WaitForPromiseAsync(operation, cancellationToken)
            .ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.setProperty({target.Id}, {JsonSerializer.Serialize(property)}, {JsonSerializer.Serialize(value.Json)})",
            "htmlml-interop-set-property.js",
            cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.release({reference.Id})",
            "htmlml-interop-release.js",
            cancellationToken).ConfigureAwait(false);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var result = await EvaluateAsync(
                $"globalThis.__htmlMlDotNetInterop.createCallbackTarget({targetId}, {JsonSerializer.Serialize(methodsJson)})",
                "htmlml-interop-register-callback.js",
                cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        var json = await EvaluateAsync(
            "globalThis.__htmlMlDotNetInterop.takeCallback()",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
            var json = await EvaluateAsync(
                $"globalThis.__htmlMlDotNetInterop.createCallbackFunction({targetId}, {JsonSerializer.Serialize(returnKind.ToString())})",
                "htmlml-interop-register-function.js",
                cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
            var json = await EvaluateAsync(
                $"globalThis.__htmlMlDotNetInterop.createSynchronousFactory({targetId}, {result.Id})",
                "htmlml-interop-register-synchronous-factory.js",
                cancellationToken).ConfigureAwait(false);
            var reference = new JavaScriptObjectReference(DeserializeRequired<long>(json));
            lock (_callbackTargets)
            {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        var json = await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.invokeFunction({function.Id}, {SerializeArguments(arguments)})",
            "htmlml-interop-invoke-function.js",
            cancellationToken).ConfigureAwait(false);
        return Deserialize<T>(json);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await EnsureInitializedAsync(cancellationToken).ConfigureAwait(false);
        await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.invokeFunctionVoid({function.Id}, {SerializeArguments(arguments)})",
            "htmlml-interop-invoke-function-void.js",
            cancellationToken).ConfigureAwait(false);
    }
    ...
    private async ValueTask EnsureInitializedAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await EvaluateAsync(
                Bootstrap,
                "htmlml-native-dotnet-interop.js",
                cancellationToken).ConfigureAwait(false);
            _initialized = true;
        }
        finally
    ...
    private T DeserializeRequired<T>(string json)
        => Deserialize<T>(json)
           ?? throw new InvalidOperationException(
               $"The native HtmlML engine returned null for {typeof(T).Name}.");
        ...
        try
        {
            while (true)
            {
                var stateJson = await EvaluateAsync(
                    $"globalThis.__htmlMlDotNetInterop.takePromise({operation})",
    ...
    private async ValueTask CompleteCallbackAsync(
        ...
        CancellationToken cancellationToken)
        => await EvaluateAsync(
            $"globalThis.__htmlMlDotNetInterop.completeCallback({call}, {(succeeded ? "true" : "false")}, {JsonSerializer.Serialize(json)})",
            "htmlml-interop-complete-callback.js",
            cancellationToken).ConfigureAwait(false);
    ...
    private static string Invocation(
        ...
        string method,
        IReadOnlyList<JavaScriptArgument> arguments)
        => $"globalThis.__htmlMlDotNetInterop.{operation}({target.Id}, {JsonSerializer.Serialize(method)}, {SerializeArguments(arguments)})";

    private static string GlobalInvocation(
        string operation,
        string globalName,
        IReadOnlyList<JavaScriptArgument> arguments)
        => $"globalThis.__htmlMlDotNetInterop.{operation}({JsonSerializer.Serialize(globalName)}, {SerializeArguments(arguments)})";
